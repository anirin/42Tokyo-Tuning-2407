...
use cache::edge_cache;
use cache::node_cache;
...
async fn main() -> std::io::Result<()> {
	...
	edge_cache::cache_edges(MapRepositoryImpl::new(pool.clone())).await;
	node_cache::cache_nodes(MapRepositoryImpl::new(pool.clone())).await;
